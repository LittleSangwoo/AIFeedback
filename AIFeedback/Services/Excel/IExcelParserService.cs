...
namespace AIFeedback.Services.Excel
{
    ...
    {
        // Основной парсер для текущего файла (цифры + комментарии для ИИ)
        ...
        // НОВЫЙ МЕТОД: Легковесный парсер для исторических файлов тренда (только цифры)
    ...
    public class ExcelParserService : IExcelParserService
    {
        ...
        public async Task<(string ProgramName, int ListenerCount, Dictionary<string, double> NumericAverages, List<string> AllComments, int Dist1to3, int Dist4to7, int Dist8to10)> ParseAsync(Stream fileStream)
        {
            return await Task.Run(() =>
            {
                ...
                // --- СЧЕТЧИКИ ДЛЯ ГРАФИКА РАСПРЕДЕЛЕНИЯ ---
        ...
        // =========================================================================
        // НОВЫЙ МЕТОД: Быстрый парсинг исторических файлов ТОЛЬКО для расчета балла
        // =========================================================================
        public async Task<double> ParseHistoryFileAsync(Stream fileStream)
        {
            return await Task.Run(() =>
            {
                ...
                // Возвращаем средний балл по всему файлу
